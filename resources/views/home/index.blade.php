...
<body>
    ...
    <header id="home" class="header-area">
        ...
        <div id="parallax" class="header-content d-flex align-items-center">
            <div class="header-shape shape-one layer" data-depth="0.10">
                <img src="portfolio_company/assets/images/banner/shape/shape-1.png" alt="Shape">
            </div> <!-- header shape -->
            <div class="header-shape shape-tow layer" data-depth="0.30">
                <img src="portfolio_company/assets/images/banner/shape/shape-2.png" alt="Shape">
            </div> <!-- header shape -->
            <div class="header-shape shape-three layer" data-depth="0.40">
                <img src="portfolio_company/assets/images/banner/shape/shape-3.png" alt="Shape">
            </div> <!-- header shape -->
            ...
            <div class="header-shape shape-six layer" data-depth="0.15">
                <img src="portfolio_company/assets/images/banner/shape/shape-4.png" alt="Shape">
            </div> <!-- header shape -->
            <div class="header-shape shape-seven layer" data-depth="0.50">
                <img src="portfolio_company/assets/images/banner/shape/shape-5.png" alt="Shape">
            </div> <!-- header shape -->
            <div class="header-shape shape-eight layer" data-depth="0.40">
                <img src="portfolio_company/assets/images/banner/shape/shape-3.png" alt="Shape">
            </div> <!-- header shape -->
            <div class="header-shape shape-nine layer" data-depth="0.20">
                <img src="portfolio_company/assets/images/banner/shape/shape-6.png" alt="Shape">
            </div> <!-- header shape -->
                ...
                <div class="row align-items-center">
                    <div class="col-xl-5 col-lg-6">
                        <div class="header-content-right">
                            ...
                            <h1 class="title">Xsis Berkarya</h1>
                            <p>Service Freight Forwading</p>
                            <a class="main-btn" href="/portfolio">View my Work</a>
                        </div> <!-- header content right -->
                    </div>
                    <div class="col-lg-6 offset-xl-1">
                        <div class="header-image d-none d-lg-block">
                            <img src="portfolio_company/assets/images/banner/hero3.png" alt="hero">
                        </div> <!-- header image -->
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->
            ...
            <div class="row">
                <div class="col-lg-15">
                    <div class="about-content mt-50">
                        <h4 class="about-title"><b> Hi There! I'm PT XSIS BERKARYA</b></h4>
                        <p align="justify" >Kami adalah perusahaan yang bergerak dalam bidang Freight Forwarding dengan layanan pengiriman Door to Door, Door to Port, Port to Door dan Port to Port Service untuk membantu klien-klien kami dalam menangani proses pengiriman Mobil, Motor, Alat Berat, dan Barang kargo dengan jangkauan pengiriman dari dan ke seluruh wilayah Indonesia. Berkantor pusat di lokasi yang strategis, Melalui tenaga personil yang
                            handal dan profesional, serta kerjasama yang baik dengan beberapa pelayaran dan maskapai asuransi
                            terbaik di Indonesia, kami siap memberikan Pelayanan Terbaik untuk Kepuasan seluruh Pelanggan.</p>
                        <ul class="clearfix">
                            <li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-service text-center mt-30">
                        <div class="service-icon">
                            <img src="/image/{{ $service->image }}" alt="" class="img-fluid" width="150">
                        </div>
    ...
    style="background-image: url(portfolio_company/assets/images//call-to-action.jpg)">
    <div class="container">
        
                <div class="call-action-content text-center">
                    <h1 class="action-title">4 PILAR MENJADI VISI MISI KAMI</h1>
                    <p>Kami percaya, bisnis yang baik berawal dari nilai perusahaan yang baik. Dalam setiap proses bisnisnya, kami selalu berusahaan menerapkan <b> 4 Pilar </b> utama yang disebut <b> RISE </b></p>
                        
                            {{-- CARD --}}
                                <div class="row pb-5 mb-4">
                                    <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                                    <div class="card rounded shadow-sm border-0 h-100">
                                        <div class="card-body p-4"><img src="portfolio_company/assets/images/s1.png" alt="" class="img-fluid d-block mx-auto mb-3">
                                            <h5><strong> <a href="#" style="color: rgba(167, 73, 255, 0.918)">RESPECT</a></h5></strong><br>
                                            <p class="small text-muted"><b> Kami selalu mendengar saran dan kritik dari stakeholder dalam upaya meningkatkan kualitas pelayanan dan tanggung jawab kami</b></p>
                                    ...
                                    <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                                    <div class="card rounded shadow-sm border-0 h-100">
                                        <div class="card-body p-3"><img src="portfolio_company/assets/images/s2.png" alt="" class="img-fluid d-block mx-auto mb-3">
                                            <h5><strong> <a href="#" style="color: rgba(167, 73, 255, 0.918)">INOVATIVE</a></h5></strong><br>
                                            <p class="small text-muted"><b> Kami mendorong lahirnya gagasan brilian yang mampu menjadi game changer di industri logistik tanah air. kami selalu berinvestasi dalam teknologi dan human capital</b></p>
                                    ...
                                    <div class="card rounded shadow-sm border-0">
                                        <div class="card-body p-4"><img src="portfolio_company/assets/images/s3.png" alt="" class="img-fluid d-block mx-auto mb-3">
                                            <h5><strong> <a href="#" style="color: rgba(167, 73, 255, 0.918)">SAFE</a></h5></strong><br>
                                        <p class="small text-muted"><b> Bagi kami keselamatan adalah nomor satu. Hal ini berlaku bagi siapa saja, baik Transporter, Shipper, Publik hingga wilayah operasional kami. </b></p>
                                    ...
                                    <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                                    <div class="card rounded shadow-sm border-0">
                                        <div class="card-body p-4"><img src="portfolio_company/assets/images/s4.png" alt="" class="img-fluid d-block mx-auto mb-3">
                                            <h5><strong> <a href="#" style="color: rgba(167, 73, 255, 0.918)">ENTREPRENEURIAL</a></h5></strong><br>
                                        <p class="small text-muted"><b> Setiap individu di dalam tim memiliki semangat kewirausahaan. Apa yang kami lakukan berdasarkan prinsip pantang menyerah dan selalu memberi yang terbaik.</b></p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-work text-center mt-30">
                        <div class="work-image">
                            <img src="portfolio_company/assets/images/work/a-1.jpg" alt="work">
                        </div>
                        <div class="work-overlay">
                            <div class="work-content">
                                <h3 class="work-title">Product Design</h3>
                                <ul>
                                    <li><a class="image-popup" href="portfolio_company/assets/images/work/a-1.jpg"><i class="lni-plus"></i></a></li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-7">
                    <div class="contact-box text-center mt-30">
                        ...
                        <div class="contact-content">
                            ...
                            <p>GEDUNG ARVA LT 3 <br> Jl. Cikini Raya No.60 FMGN, Kel Cikini Kecamatan Menteng, Jakarta Pusat 10330</p>
                        </div>
                    </div> <!-- contact box -->
                </div>
                <div class="col-lg-4 col-md-6 col-sm-7">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="footer-content text-center">
                            ...
                            <p class="mt-">Profesional, Berpengalaman, dan Terpercaya, di bidang freight forwading membantu klien dalam melakukan pengiriman Mobil, Motor, Alat Berat, dan Barang Kargo dari dan ke seluruh wilayah Indonesia.</p>
                            <ul>
                                <li><a href="#"><i class="lni-facebook-filled"></i></a></li>
                                <li><a href="#"><i class="lni-twitter-original"></i></a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright-text text-center pt-20">
                            <p>Copyright © 2022. By: Kamal <a href="https://uideck.com" rel="nofollow">XSIS Berkarya</a></p>
                        </div> <!-- copyright text -->
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->
